...
class Sock
{
	...
	public $master; //socket的resource，即前期出事socket时返回的socket资源
	...
	public function __construct($address, $port){
		//创建socket并把保存的socket资源在$this->master
    ...
    */
	...
	public function WebSocket($address, $port){
		...
		socket_set_option($server, SOL_SOCKET, SO_REUSEADDR, 1); //1.表示接收所有的数据包
